...
//
//                     try {
//                         const res = await fetch('http://localhost:1111/api/userquery', {
//                             method: 'POST',
...
//
//                     try {
//                         const res = await fetch("http://localhost:1111/api/repartiQuery", {
//                             method: 'POST',
//                             headers: { 'Content-Type': 'application/json' },
...
//
//                     try {
//                         const res = await fetch("http://localhost:1111/api/addUser", {
//                             method: 'POST',
//                             headers: { 'Content-Type': 'application/json' },
...
//
//                     try {
//                         const res = await fetch('http://localhost:1111/api/foundQuery', {
//                             method: 'POST',
//                             headers: { 'Content-Type': 'application/json' },
//                             body: JSON.stringify({ name: n, sourname: c })
//                         });
...
//
//                             try {
//                                 const res = await fetch('http://localhost:1111/api/removeById', {
//                                     method: 'POST',
//                                     headers: { 'Content-Type': 'application/json' },
...
//
//                                     try {
//                                         const res = await fetch("http://localhost:1111/api/modifyById", {
//                                             method: 'POST',
//                                             headers: { 'Content-Type': 'application/json' },
